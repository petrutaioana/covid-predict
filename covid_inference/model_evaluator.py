...
def evaluate(inference, results):
    ...
    precision = precision_score(results, inference, average='macro')
    recall = recall_score(results, inference, average='macro')
    f1 = f1_score(results, inference, average='macro')
